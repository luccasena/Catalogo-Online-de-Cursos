...
use PHPMailer\PHPMailer\Exception;
    ...
    function inscrever_curso($email, $nome, $curso){
        ...
        try {
            ...
            $mail->Username   = '';                                     // O e-mail da empresa. (Não inserido por questões de segurança)
            $mail->Password   = '';                                     // A senha do e-mail da empresa. (Não inserido por questões de segurança)
