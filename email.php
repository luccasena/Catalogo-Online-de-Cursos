<?php
    ...
    */
    ...
    function enviar_email($email, $nome){
        ...
        $dotenv = Dotenv\Dotenv::createImmutable(__DIR__);  // Essa instância é essencial para manter a confiabilidade dos dados da empresa, sem que ela seja vazada.
        $dotenv->load;                                      // Se faz necessário um arquivo .env que irá armazenar o login e a senha utilizada para o envio de e-mails, interessante que esteja na mesma pasta desse código.
